...
public class CuentaBancaria {
	...
	// al dinero disponible para simular un efecto de pérdida del poder adquisitivo.
	...
	// Se podría hacer un registro de auditoría en el que se pueda ver las acciones de los usuarios.
